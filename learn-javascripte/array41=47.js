...
دالة المقارنة (a, b) => b - a:

تقوم هذه الدالة بتحديد كيفية ترتيب العناصر. إذا كانت القيمة المُرجعة إيجابية، يعني أن a يجب أن يكون أمام b، وإذا كانت سالبة، يعني أن b يجب أن يكون أمام a. ببساطة، هذا يعكس الترتيب لتكون ترتيبًا تنازليًا.

في حالتنا، b - a يعني إذا كانت b أكبر من a، ستكون القيمة المرجعة إيجابية، مما يعني أن b سيتم وضعها قبل a في الترتيب.

لنعطي مثالًا على فهم كيفية عمل ذلك:

javascript
Copy code
let numbers = [20, 100, 50, 10, 15, -20, 30];

// فرز التصاعدي (تصاعديًا)
let ascendingOrder = numbers.slice().sort((a, b) => a - b);
console.log(ascendingOrder); // [-20, 10, 15, 20, 30, 50, 100]

// فرز تنازلي (تنازليًا)
let descendingOrder = numbers.slice().sort((a, b) => b - a);
console.log(descendingOrder); // [100, 50, 30, 20, 15, 10, -20]
*/
////////////////////////////////////////////////////////////
/*
الدرس 45 :
